	...
	<div class="row justify-content-center">
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					<form action="{{ route('cetak.pembelian_pdf') }}" method="POST" target="_blank"> 
                    @csrf
						<fieldset>
							<div class="form-group row">
								<div class="col-md-3">
									<label for="klasifikasi">Periode Pembelian</label>
									<input id="jenis" type="hidden" name="jenis" value="pembelian" class="formcontrol">
