...
<body>
	<table class="table table-bordered" width="100%" align="center">
		<tr align="center">
			<td>
				<h2>Laporan Jurnal Umum<br>Teras Aloha Coffee Bogor</h2>
				<hr> </td>
		</tr>
	</table>
	<table class="table table-bordered" width="100%" align="center">
		...
		<tbody> @php $subtotal1 = 0; $subtotal2 = 0; @endphp @foreach ($laporan as $akn)
			<!-- <tr>
 <td colspan="5">{{$akn->tgl_jurnal}}</td>
 </tr> -->@foreach ($laporan as $bb)
			<!-- pembuatan prulangan bersarang -->@if($loop->parent->first)
			<tr>
				<td>{{$bb->tgl_jurnal}}</td>
