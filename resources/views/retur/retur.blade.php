			...
			<table class="table table-bordered tablestriped" id="dataTable" width="100%" cellspacing="0">
				...
				<tbody> @foreach($pembelian as $beli)
					<tr>
						...
						<td width="30%"> <a href="{{url('/retur-beli/'.Crypt::encryptString($beli->no_faktur))}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadowsm"><i class="fas fa-recycle fa-sm text-white-50"></i> Retur</a> </td>
					</tr> @endforeach </tbody>
			</table>
		</div>
	</div>
